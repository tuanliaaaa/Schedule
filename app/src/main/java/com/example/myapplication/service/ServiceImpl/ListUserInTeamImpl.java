...
public class ListUserInTeamImpl {
    private ListUserInTeamInterFace callback;
    ...
    public ListUserInTeamImpl(ListUserInTeamInterFace callback, String domain) {
        this.callback = callback;
        this.url = domain;
        this.token=null;
    }
    public ListUserInTeamImpl(ListUserInTeamInterFace callback,String domain,String token,Integer idTeam) {
        this.callback = callback;
        this.url = domain;
        this.token=token;
        this.idTeam=idTeam;
    ...
    public void getAllUser(Context context) {
        ...
        try {
            jsonObjectRequest = new JsonObjectRequest(
                    Request.Method.GET,
                    url + "/team/member/"+String.valueOf(idTeam),
                    null,
