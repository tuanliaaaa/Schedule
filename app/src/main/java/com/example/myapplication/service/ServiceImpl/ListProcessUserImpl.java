...
public class ListProcessUserImpl {
    private ListProcessUserInterFace callback;
    ...
    public ListProcessUserImpl(ListProcessUserInterFace callback, String domain) {
        this.callback = callback;
        this.url = domain;
        this.token=null;
    }
    public ListProcessUserImpl(ListProcessUserInterFace callback,String domain,String token,Integer id) {
        this.callback = callback;
        this.url = domain;
        this.token=token;
    ...
    public void getAll(Context context) {
        ...
        try {
            jsonObjectRequest = new JsonObjectRequest(
                    Request.Method.GET,
                    url + "/Assignment/AssigmentManage/"+id,
                    null,
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                Type responseType = new TypeToken<ApiResponse<ProcessUserResponse>>(){}.getType();
                                ApiResponse<ProcessUserResponse> apiResponse = gson.fromJson(response.toString(), responseType);
                                Log.d("Data from get Data ",apiResponse.getData().toString());
